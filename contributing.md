...
First and foremost, thank you! We appreciate that you want to contribute to step, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for step**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for step:

- star the [project](https://github.com/seanc/step)
- tweet your support for step
...
- **version**: please note the version of step are you using
...
[so]: http://stackoverflow.com/questions/tagged/step